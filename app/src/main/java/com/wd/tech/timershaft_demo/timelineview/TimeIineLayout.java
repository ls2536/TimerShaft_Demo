package com.wd.tech.timershaft_demo.timelineview;
...
import com.wd.tech.timershaft_demo.R;
 ...
 * @fileName:TimeIineLayout
 * @packageName:com.wd.tech.timershaft_demo.timelineview
 */
public class TimeIineLayout extends LinearLayout {
    ...
    public TimeIineLayout(Context context) {
        this(context, null);
    }

    public TimeIineLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TimeIineLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mLineColor = ta.getColor(R.styleable.TimelineLayout_line_color, Color.RED);
        mPointSize = ta.getDimensionPixelSize(R.styleable.TimelineLayout_point_size, 8);
        mPointColor = ta.getDimensionPixelOffset(R.styleable.TimelineLayout_point_color, Color.RED);
